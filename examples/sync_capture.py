...
picam2 = Picamera2()
ctrls = {'FrameRate': 30.0, 'SyncMode': controls.SyncModeEnum.Server}
...
# THe timer tells many microseconds we were away from the synchronisation point.
# Normally this should be small, but may be much larger if frames are being dropped.
print("Timer:", req.get_metadata()['SyncTimer'])
